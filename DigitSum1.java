 ...
 * 
 * If parameter is >= 10 then the method should process the number and return sumof all 
 ...
 */
 ...
 private static int sumDigits(int number)
 {
    ...
    //To extract the least significant digit of 125 (5) 
    ...
    while(number > 0)
    {
        ...
        //Drop least-significicant digit
